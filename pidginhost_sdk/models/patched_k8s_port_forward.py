...
class PatchedK8sPortForward(BaseModel):
    """
    PatchedK8sPortForward
    """ # noqa: E501
    id: Optional[StrictInt] = None
    internal_ip: Optional[Annotated[str, Field(strict=True, max_length=15)]] = None
    port: Optional[Annotated[int, Field(le=32767, strict=True, ge=0)]] = None
    protocol: Optional[ProtocolEnum] = None
    __properties: ClassVar[List[str]] = ["id", "internal_ip", "port", "protocol"]
