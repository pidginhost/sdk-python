...
class TestPatchedInboundRoute(unittest.TestCase):
    """PatchedInboundRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedInboundRoute:
        """Test PatchedInboundRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedInboundRoute`
        """
        model = PatchedInboundRoute()
        if include_optional:
            return PatchedInboundRoute(
                id = 56,
                domain = 56,
                pattern = '',
                mode = 'webhook',
    ...
    def testPatchedInboundRoute(self):
        """Test PatchedInboundRoute"""
