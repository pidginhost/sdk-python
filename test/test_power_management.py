...
class TestPowerManagement(unittest.TestCase):
    """PowerManagement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerManagement:
        """Test PowerManagement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerManagement`
        """
