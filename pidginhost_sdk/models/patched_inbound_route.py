...
class PatchedInboundRoute(BaseModel):
    """
    PatchedInboundRoute
    """ # noqa: E501
    id: Optional[StrictInt] = None
    domain: Optional[StrictInt] = None
    pattern: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    mode: Optional[ModeEnum] = None
    webhook_url: Optional[Annotated[str, Field(strict=True, max_length=200)]] = None
    forward_to: Optional[Annotated[str, Field(strict=True, max_length=254)]] = None
    active: Optional[StrictBool] = None
    created_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "domain", "pattern", "mode", "webhook_url", "forward_to", "active", "created_at"]
