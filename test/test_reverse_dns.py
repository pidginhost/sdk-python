...
class TestReverseDNS(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReverseDNS:
        """Test ReverseDNS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReverseDNS`
        """
        model = ReverseDNS()
        if include_optional:
            return ReverseDNS(
