...
class TestServerProductUpgrade(unittest.TestCase):
    """ServerProductUpgrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerProductUpgrade:
        """Test ServerProductUpgrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerProductUpgrade`
        """
        model = ServerProductUpgrade()
        if include_optional:
            return ServerProductUpgrade(
                package = ''
            )
        else:
            return ServerProductUpgrade(
    ...
    def testServerProductUpgrade(self):
        """Test ServerProductUpgrade"""
