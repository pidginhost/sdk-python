...
class TestPatchedEmailService(unittest.TestCase):
    """PatchedEmailService unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedEmailService:
        """Test PatchedEmailService
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedEmailService`
        """
        model = PatchedEmailService()
        if include_optional:
            return PatchedEmailService(
                id = 56,
                tier = '',
                status = 'pending',
                sandbox_mode = True,
    ...
    def testPatchedEmailService(self):
        """Test PatchedEmailService"""
