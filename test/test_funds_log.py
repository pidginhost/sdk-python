...
class TestFundsLog(unittest.TestCase):
    """FundsLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundsLog:
        """Test FundsLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundsLog`
        """
        model = FundsLog()
        if include_optional:
            return FundsLog(
