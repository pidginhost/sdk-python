...
class PatchedServerDetail(BaseModel):
    ...
    floating_ips: Optional[List[FloatingIPSummary]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "hostname", "project", "image", "package", "cpus", "memory", "disk_size", "generation", "machine", "volumes", "networks", "floating_ips", "password", "status", "username", "destroy_protection", "ha_enabled"]
