...
class InvoiceDetail(BaseModel):
    ...
    @field_validator('vat_value', mode="before")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if usage_detail (nullable) is None
        # and model_fields_set contains the field
        if self.usage_detail is None and "usage_detail" in self.model_fields_set:
            _dict['usage_detail'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usage_detail": obj.get("usage_detail"),
