...
class TestEmailHistory(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EmailHistory:
        """Test EmailHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailHistory`
        """
        model = EmailHistory()
        if include_optional:
            return EmailHistory(
