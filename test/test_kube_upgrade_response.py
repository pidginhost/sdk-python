...
class TestKubeUpgradeResponse(unittest.TestCase):
    """KubeUpgradeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KubeUpgradeResponse:
        """Test KubeUpgradeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KubeUpgradeResponse`
        """
        model = KubeUpgradeResponse()
        if include_optional:
    ...
    def testKubeUpgradeResponse(self):
        """Test KubeUpgradeResponse"""
