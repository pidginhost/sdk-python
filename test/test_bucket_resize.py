...
class TestBucketResize(unittest.TestCase):
    """BucketResize unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketResize:
        """Test BucketResize
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketResize`
        """
        model = BucketResize()
        if include_optional:
            return BucketResize(
