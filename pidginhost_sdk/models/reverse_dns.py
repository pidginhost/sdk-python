...
class ReverseDNS(BaseModel):
    ...
    ReverseDNS
    """ # noqa: E501
    reverse_dns: Annotated[str, Field(strict=True, max_length=200)] = Field(description="Fully-qualified domain name for PTR record (e.g., host.example.com)")
    __properties: ClassVar[List[str]] = ["reverse_dns"]
