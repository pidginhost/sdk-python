...
class PatchedServerDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "hostname", "project", "image", "package", "cpus", "memory", "disk_size", "machine", "volumes", "networks", "password", "status", "username", "destroy_protection", "ha_enabled"]
