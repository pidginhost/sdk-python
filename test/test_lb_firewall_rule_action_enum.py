...
class TestLBFirewallRuleActionEnum(unittest.TestCase):
    """LBFirewallRuleActionEnum unit test stubs"""
    ...
    def testLBFirewallRuleActionEnum(self):
        """Test LBFirewallRuleActionEnum"""
        # inst = LBFirewallRuleActionEnum()
