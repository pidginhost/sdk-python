...
class TestFirewallRuleDirectionEnum(unittest.TestCase):
    """FirewallRuleDirectionEnum unit test stubs"""
    ...
    def testFirewallRuleDirectionEnum(self):
        """Test FirewallRuleDirectionEnum"""
        # inst = FirewallRuleDirectionEnum()
