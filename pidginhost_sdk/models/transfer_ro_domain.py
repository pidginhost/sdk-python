...
class TransferRoDomain(BaseModel):
    """
    TransferRoDomain
    """ # noqa: E501
    domain: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Domain with tld, ex: example.com")
    auth_code: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Auth code")
    __properties: ClassVar[List[str]] = ["domain", "auth_code"]
