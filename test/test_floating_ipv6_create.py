...
class TestFloatingIPv6Create(unittest.TestCase):
    """FloatingIPv6Create unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv6Create:
        """Test FloatingIPv6Create
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv6Create`
        """
        model = FloatingIPv6Create()
        if include_optional:
            return FloatingIPv6Create(
                label = ''
            )
        else:
            return FloatingIPv6Create(
    ...
    def testFloatingIPv6Create(self):
        """Test FloatingIPv6Create"""
