...
class TestPaginatedSnapshotList(unittest.TestCase):
    """PaginatedSnapshotList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSnapshotList:
        """Test PaginatedSnapshotList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSnapshotList`
        """
        model = PaginatedSnapshotList()
        if include_optional:
            return PaginatedSnapshotList(
                ...
                results = [
                    pidginhost_sdk.models.snapshot.Snapshot(
                        name = '', 
                        description = '', 
                        state = '', 
                        created_at = '', 
    ...
    def testPaginatedSnapshotList(self):
        """Test PaginatedSnapshotList"""
