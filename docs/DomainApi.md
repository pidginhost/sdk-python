...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DomainApi->domain_domain_dns_create: %s\n" % e)
```
...
Delete a glue / personal-DNS record (and deregister the nameserver
host at the registrar).
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.domain_domain_dns_destroy(domain, name)
    except Exception as e:
        print("Exception when calling DomainApi->domain_domain_dns_destroy: %s\n" % e)
```
...
> PaginatedDNSGlueList domain_domain_dns_list(domain, page=page)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.domain_domain_dns_list(domain, page=page)
        print("The response of DomainApi->domain_domain_dns_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DomainApi->domain_domain_dns_list: %s\n" % e)
```
