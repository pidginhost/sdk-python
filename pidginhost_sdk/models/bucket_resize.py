...
class BucketResize(BaseModel):
    """
    BucketResize
    """ # noqa: E501
    quota_gb: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["quota_gb"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BucketResize from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BucketResize from a dict"""
        if obj is None:
            return None
