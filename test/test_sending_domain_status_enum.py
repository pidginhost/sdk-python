...
class TestSendingDomainStatusEnum(unittest.TestCase):
    """SendingDomainStatusEnum unit test stubs"""
    ...
    def testSendingDomainStatusEnum(self):
        """Test SendingDomainStatusEnum"""
        # inst = SendingDomainStatusEnum()
