...
class TestPaginatedBootISOList(unittest.TestCase):
    """PaginatedBootISOList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedBootISOList:
        """Test PaginatedBootISOList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedBootISOList`
        """
        model = PaginatedBootISOList()
        if include_optional:
            return PaginatedBootISOList(
                ...
                results = [
                    pidginhost_sdk.models.boot_iso.BootISO(
                        slug = 'z', 
                        name = '', 
                        description = '', 
                        category = 'rescue', 
    ...
    def testPaginatedBootISOList(self):
        """Test PaginatedBootISOList"""
