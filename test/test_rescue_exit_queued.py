...
class TestRescueExitQueued(unittest.TestCase):
    """RescueExitQueued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RescueExitQueued:
        """Test RescueExitQueued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RescueExitQueued`
        """
        model = RescueExitQueued()
        if include_optional:
            return RescueExitQueued(
                queued = True
            )
        else:
            return RescueExitQueued(
