...
class TestPaginatedDepositList(unittest.TestCase):
    """PaginatedDepositList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedDepositList:
        """Test PaginatedDepositList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedDepositList`
        """
        model = PaginatedDepositList()
        if include_optional:
            return PaginatedDepositList(
                ...
                results = [
                    pidginhost_sdk.models.deposit.Deposit(
                        id = 56, 
                        status = null, 
                        amount = '-80728880', 
                        vat_value = '-80728880', 
    ...
    def testPaginatedDepositList(self):
        """Test PaginatedDepositList"""
