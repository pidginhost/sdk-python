...
class TestPrivateNetworkRemoveHost(unittest.TestCase):
    """PrivateNetworkRemoveHost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateNetworkRemoveHost:
        """Test PrivateNetworkRemoveHost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateNetworkRemoveHost`
        """
        model = PrivateNetworkRemoveHost()
        if include_optional:
            return PrivateNetworkRemoveHost(
                server = ''
            )
        else:
            return PrivateNetworkRemoveHost(
    ...
    def testPrivateNetworkRemoveHost(self):
        """Test PrivateNetworkRemoveHost"""
