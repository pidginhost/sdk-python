...
class TestConnectedVM(unittest.TestCase):
    """ConnectedVM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedVM:
        """Test ConnectedVM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectedVM`
        """
        model = ConnectedVM()
        if include_optional:
            return ConnectedVM(
