...
**user_data** | **str** | Optional startup script. Must be an executable script with a shebang. Stored in cleartext. | [optional] 
**public_ip** | **str** | ID or address of an IPv4 you already own. Aliases accepted: ipv4, public_ipv4. | [optional] 
**new_ipv4** | **bool** | Allocate a new IPv4 and attach it before first boot, so the server boots reachable. | [optional] 
**public_ipv6** | **str** | ID or address of an IPv6 you already own. Alias accepted: ipv6. | [optional] 
