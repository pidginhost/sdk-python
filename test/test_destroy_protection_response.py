...
class TestDestroyProtectionResponse(unittest.TestCase):
    """DestroyProtectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestroyProtectionResponse:
        """Test DestroyProtectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestroyProtectionResponse`
        """
        model = DestroyProtectionResponse()
        if include_optional:
            return DestroyProtectionResponse(
    ...
    def testDestroyProtectionResponse(self):
        """Test DestroyProtectionResponse"""
