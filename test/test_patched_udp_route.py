...
class TestPatchedUDPRoute(unittest.TestCase):
    """PatchedUDPRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedUDPRoute:
        """Test PatchedUDPRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedUDPRoute`
        """
        model = PatchedUDPRoute()
        if include_optional:
            return PatchedUDPRoute(
                id = 56,
                name = '',
                namespace = '',
                port = 1,
