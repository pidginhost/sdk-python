...
class TestResourcePoolNode(unittest.TestCase):
    """ResourcePoolNode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourcePoolNode:
        """Test ResourcePoolNode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourcePoolNode`
        """
        model = ResourcePoolNode()
        if include_optional:
