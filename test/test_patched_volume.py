...
class TestPatchedVolume(unittest.TestCase):
    """PatchedVolume unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedVolume:
        """Test PatchedVolume
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedVolume`
        """
        model = PatchedVolume()
        if include_optional:
            return PatchedVolume(
                id = 56,
                project = '',
                alias = '',
                size = 0,
