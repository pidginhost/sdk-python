...
class TestRenewDomain(unittest.TestCase):
    """RenewDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RenewDomain:
        """Test RenewDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RenewDomain`
        """
        model = RenewDomain()
        if include_optional:
            return RenewDomain(
