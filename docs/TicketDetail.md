...
**priority** | [**TicketPriorityEnum**](TicketPriorityEnum.md) |  | [readonly] 
**status** | [**TicketStatusEnum**](TicketStatusEnum.md) |  | [readonly] 
**created** | **str** |  | [readonly] 
**updated** | **str** |  | [readonly] 
**messages** | [**List[TicketMessage]**](TicketMessage.md) |  | [readonly] 
