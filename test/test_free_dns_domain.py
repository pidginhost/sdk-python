...
class TestFreeDNSDomain(unittest.TestCase):
    """FreeDNSDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FreeDNSDomain:
        """Test FreeDNSDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FreeDNSDomain`
        """
        model = FreeDNSDomain()
        if include_optional:
