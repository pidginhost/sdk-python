...
class TestDNSRecordCreateTypeEnum(unittest.TestCase):
    """DNSRecordCreateTypeEnum unit test stubs"""
    ...
    def testDNSRecordCreateTypeEnum(self):
        """Test DNSRecordCreateTypeEnum"""
        # inst = DNSRecordCreateTypeEnum()
