...
class TestRDNSUpdateResponse(unittest.TestCase):
    """RDNSUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RDNSUpdateResponse:
        """Test RDNSUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RDNSUpdateResponse`
        """
        model = RDNSUpdateResponse()
        if include_optional:
    ...
    def testRDNSUpdateResponse(self):
        """Test RDNSUpdateResponse"""
