...
class TestAttachVolume(unittest.TestCase):
    """AttachVolume unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachVolume:
        """Test AttachVolume
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachVolume`
        """
        model = AttachVolume()
        if include_optional:
            return AttachVolume(
