...
class TestPaginatedResourcePoolList(unittest.TestCase):
    """PaginatedResourcePoolList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResourcePoolList:
        """Test PaginatedResourcePoolList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResourcePoolList`
        """
        model = PaginatedResourcePoolList()
        if include_optional:
            return PaginatedResourcePoolList(
                ...
                results = [
                    pidginhost_sdk.models.resource_pool.ResourcePool(
                        id = 56, 
                        package = '', 
                        size = '', 
                        nodes = [
    ...
    def testPaginatedResourcePoolList(self):
        """Test PaginatedResourcePoolList"""
