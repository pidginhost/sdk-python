...
class TestTalosUpgradeResponse(unittest.TestCase):
    """TalosUpgradeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TalosUpgradeResponse:
        """Test TalosUpgradeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TalosUpgradeResponse`
        """
        model = TalosUpgradeResponse()
        if include_optional:
    ...
    def testTalosUpgradeResponse(self):
        """Test TalosUpgradeResponse"""
