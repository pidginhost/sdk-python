...
class TestActivateFreeDNSResponse(unittest.TestCase):
    """ActivateFreeDNSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivateFreeDNSResponse:
        """Test ActivateFreeDNSResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivateFreeDNSResponse`
        """
        model = ActivateFreeDNSResponse()
        if include_optional:
    ...
    def testActivateFreeDNSResponse(self):
        """Test ActivateFreeDNSResponse"""
