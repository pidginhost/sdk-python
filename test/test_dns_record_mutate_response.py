...
class TestDNSRecordMutateResponse(unittest.TestCase):
    """DNSRecordMutateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSRecordMutateResponse:
        """Test DNSRecordMutateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSRecordMutateResponse`
        """
        model = DNSRecordMutateResponse()
        if include_optional:
            return DNSRecordMutateResponse(
                message = '',
                record = pidginhost_sdk.models.dns_record.DNSRecord(
                    line = 56, 
                    name = '', 
                    ttl = 56, 
                    type = '', 
    ...
    def testDNSRecordMutateResponse(self):
        """Test DNSRecordMutateResponse"""
