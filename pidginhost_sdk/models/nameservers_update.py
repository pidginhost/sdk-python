...
class NameserversUpdate(BaseModel):
    ...
    NameserversUpdate
    """ # noqa: E501
    nameservers: Annotated[List[Annotated[str, Field(strict=True, max_length=255)]], Field(min_length=2, max_length=5)] = Field(description="List of 2-5 nameserver hostnames")
    __properties: ClassVar[List[str]] = ["nameservers"]
