...
class Bucket(BaseModel):
    ...
    public_read: StrictBool
    status: StatusA57Enum
    endpoint: StrictStr
    region: StrictStr
    created: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "full_name", "quota_gb", "used_bytes", "object_count", "public_read", "status", "endpoint", "region", "created"]
