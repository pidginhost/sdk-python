...
class TestFirewallRulesSetStatusEnum(unittest.TestCase):
    """FirewallRulesSetStatusEnum unit test stubs"""
    ...
    def testFirewallRulesSetStatusEnum(self):
        """Test FirewallRulesSetStatusEnum"""
        # inst = FirewallRulesSetStatusEnum()
