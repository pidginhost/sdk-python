...
class TestNameserversUpdateResponse(unittest.TestCase):
    """NameserversUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NameserversUpdateResponse:
        """Test NameserversUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NameserversUpdateResponse`
        """
        model = NameserversUpdateResponse()
        if include_optional:
    ...
    def testNameserversUpdateResponse(self):
        """Test NameserversUpdateResponse"""
