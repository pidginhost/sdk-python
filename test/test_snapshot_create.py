...
class TestSnapshotCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SnapshotCreate:
        """Test SnapshotCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotCreate`
        """
        model = SnapshotCreate()
        if include_optional:
            return SnapshotCreate(
                name = 'ABAMDTMv2D2ylmgd10Z',
                description = '',
                include_memory = True
            )
        else:
