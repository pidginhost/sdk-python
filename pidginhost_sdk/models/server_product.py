...
class ServerProduct(BaseModel):
    ...
    memory: StrictInt
    disk_size: StrictInt
    traffic: StrictInt = Field(description="Included monthly traffic, in TB.")
    available_generations: List[StrictStr]
    __properties: ClassVar[List[str]] = ["id", "slug", "name", "cpus", "memory", "disk_size", "traffic", "available_generations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "available_generations": obj.get("available_generations")
        })
        return _obj
