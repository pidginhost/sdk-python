...
class TestDomainAdd(unittest.TestCase):
    """DomainAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainAdd:
        """Test DomainAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainAdd`
        """
        model = DomainAdd()
        if include_optional:
            return DomainAdd(
