...
> CLISessionCreateResponse auth_cli_session_create2()
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.auth_cli_session_create2()
        print("The response of AuthApi->auth_cli_session_create2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthApi->auth_cli_session_create2: %s\n" % e)
```
...
> CLISessionPollResponse auth_cli_session_retrieve2(session_id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.auth_cli_session_retrieve2(session_id)
        print("The response of AuthApi->auth_cli_session_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AuthApi->auth_cli_session_retrieve2: %s\n" % e)
```
