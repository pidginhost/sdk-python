...
class TestPaginatedTicketListList(unittest.TestCase):
    """PaginatedTicketListList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedTicketListList:
        """Test PaginatedTicketListList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedTicketListList`
        """
        model = PaginatedTicketListList()
        if include_optional:
            return PaginatedTicketListList(
                ...
                results = [
                    pidginhost_sdk.models.ticket_list.TicketList(
                        id = 56, 
                        subject = '', 
                        department = '', 
                        priority = null, 
    ...
    def testPaginatedTicketListList(self):
        """Test PaginatedTicketListList"""
