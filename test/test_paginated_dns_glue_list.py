...
class TestPaginatedDNSGlueList(unittest.TestCase):
    """PaginatedDNSGlueList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedDNSGlueList:
        """Test PaginatedDNSGlueList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedDNSGlueList`
        """
        model = PaginatedDNSGlueList()
        if include_optional:
            return PaginatedDNSGlueList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    pidginhost_sdk.models.dns_glue.DNSGlue(
                        name = '', 
                        ip = '', 
                        ip2 = '', )
                    ]
    ...
    def testPaginatedDNSGlueList(self):
        """Test PaginatedDNSGlueList"""
