...
class TestPaginatedHTTPRouteList(unittest.TestCase):
    """PaginatedHTTPRouteList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedHTTPRouteList:
        """Test PaginatedHTTPRouteList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedHTTPRouteList`
        """
        model = PaginatedHTTPRouteList()
        if include_optional:
            return PaginatedHTTPRouteList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    pidginhost_sdk.models.http_route.HTTPRoute(
                        id = 56, 
                        name = '', 
                        namespace = '', 
                        hostnames = [
    ...
    def testPaginatedHTTPRouteList(self):
        """Test PaginatedHTTPRouteList"""
