...
class TestPatchedSSHKey(unittest.TestCase):
    """PatchedSSHKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedSSHKey:
        """Test PatchedSSHKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedSSHKey`
        """
        model = PatchedSSHKey()
        if include_optional:
            return PatchedSSHKey(
                id = 56,
                alias = '',
                fingerprint = '',
                key = ''
