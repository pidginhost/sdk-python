...
class TestReinstallResponse(unittest.TestCase):
    """ReinstallResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReinstallResponse:
        """Test ReinstallResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReinstallResponse`
        """
        model = ReinstallResponse()
        if include_optional:
    ...
    def testReinstallResponse(self):
        """Test ReinstallResponse"""
