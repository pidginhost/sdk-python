...
class TestToggleAutoPaymentResponse(unittest.TestCase):
    """ToggleAutoPaymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToggleAutoPaymentResponse:
        """Test ToggleAutoPaymentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToggleAutoPaymentResponse`
        """
        model = ToggleAutoPaymentResponse()
        if include_optional:
    ...
    def testToggleAutoPaymentResponse(self):
        """Test ToggleAutoPaymentResponse"""
