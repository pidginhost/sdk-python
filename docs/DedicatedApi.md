...
> PaginatedDedicatedServerList dedicated_servers_list2(page=page)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dedicated_servers_list2(page=page)
        print("The response of DedicatedApi->dedicated_servers_list2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DedicatedApi->dedicated_servers_list2: %s\n" % e)
```
...
> PowerActionResponse dedicated_servers_power_create2(id, power_action)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dedicated_servers_power_create2(id, power_action)
        print("The response of DedicatedApi->dedicated_servers_power_create2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DedicatedApi->dedicated_servers_power_create2: %s\n" % e)
```
...
> RDNSUpdateResponse dedicated_servers_rdns_create2(id, dedicated_rdns)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dedicated_servers_rdns_create2(id, dedicated_rdns)
        print("The response of DedicatedApi->dedicated_servers_rdns_create2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DedicatedApi->dedicated_servers_rdns_create2: %s\n" % e)
```
...
> ReinstallResponse dedicated_servers_reinstall_create2(id, reinstall)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dedicated_servers_reinstall_create2(id, reinstall)
        print("The response of DedicatedApi->dedicated_servers_reinstall_create2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DedicatedApi->dedicated_servers_reinstall_create2: %s\n" % e)
```
...
> DedicatedServer dedicated_servers_retrieve2(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dedicated_servers_retrieve2(id)
        print("The response of DedicatedApi->dedicated_servers_retrieve2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DedicatedApi->dedicated_servers_retrieve2: %s\n" % e)
```
