...
class TestServerUsageResponse(unittest.TestCase):
    """ServerUsageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerUsageResponse:
        """Test ServerUsageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerUsageResponse`
        """
        model = ServerUsageResponse()
        if include_optional:
    ...
    def testServerUsageResponse(self):
        """Test ServerUsageResponse"""
