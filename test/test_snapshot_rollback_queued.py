...
class TestSnapshotRollbackQueued(unittest.TestCase):
    """SnapshotRollbackQueued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotRollbackQueued:
        """Test SnapshotRollbackQueued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotRollbackQueued`
        """
        model = SnapshotRollbackQueued()
        if include_optional:
    ...
    def testSnapshotRollbackQueued(self):
        """Test SnapshotRollbackQueued"""
