...
class TestTicketReplyResponse(unittest.TestCase):
    """TicketReplyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketReplyResponse:
        """Test TicketReplyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketReplyResponse`
        """
        model = TicketReplyResponse()
        if include_optional:
    ...
    def testTicketReplyResponse(self):
        """Test TicketReplyResponse"""
