...
class TestDNSGlue(unittest.TestCase):
    """DNSGlue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DNSGlue:
        """Test DNSGlue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSGlue`
        """
        model = DNSGlue()
        if include_optional:
            return DNSGlue(
