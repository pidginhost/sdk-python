...
class TestToggleCloudVMAccessResponse(unittest.TestCase):
    """ToggleCloudVMAccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ToggleCloudVMAccessResponse:
        """Test ToggleCloudVMAccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ToggleCloudVMAccessResponse`
        """
        model = ToggleCloudVMAccessResponse()
        if include_optional:
    ...
    def testToggleCloudVMAccessResponse(self):
        """Test ToggleCloudVMAccessResponse"""
