...
class TestPatchedFirewallRulesSet(unittest.TestCase):
    """PatchedFirewallRulesSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedFirewallRulesSet:
        """Test PatchedFirewallRulesSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedFirewallRulesSet`
        """
        model = PatchedFirewallRulesSet()
        if include_optional:
            return PatchedFirewallRulesSet(
                id = 56,
                name = '',
                status = 'validated',
                rules = [
                    pidginhost_sdk.models.firewall_rule.FirewallRule(
                        id = 56, 
                        direction = 'in', 
                        action = 'ACCEPT', 
                        protocol = '', 
    ...
    def testPatchedFirewallRulesSet(self):
        """Test PatchedFirewallRulesSet"""
