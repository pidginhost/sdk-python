...
class TestSandboxAddress(unittest.TestCase):
    """SandboxAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SandboxAddress:
        """Test SandboxAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SandboxAddress`
        """
        model = SandboxAddress()
        if include_optional:
