...
class DomainApi:
    ...
    def _domain_domain_dns_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/domain/domain/{domain}/dns/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def domain_domain_dns_destroy(
        ...
        _param = self._domain_domain_dns_destroy_serialize(
            domain=domain,
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def domain_domain_dns_destroy_with_http_info(
        self,
        domain: Annotated[str, Field(strict=True)],
        name: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    @validate_call
    def domain_domain_dns_destroy_without_preload_content(
        self,
        domain: Annotated[str, Field(strict=True)],
        name: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    def _domain_domain_dns_destroy_serialize(
        self,
        domain,
        name,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/domain/domain/{domain}/dns/{name}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def domain_domain_dns_list(
        ...
        _param = self._domain_domain_dns_list_serialize(
            domain=domain,
            page=page,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def domain_domain_dns_list_with_http_info(
        self,
        domain: Annotated[str, Field(strict=True)],
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedDNSGlueList]:
        """domain_domain_dns_list
    ...
    @validate_call
    def domain_domain_dns_list_without_preload_content(
        self,
        domain: Annotated[str, Field(strict=True)],
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        _request_timeout: Union[
    ...
    def _domain_domain_dns_list_serialize(
        self,
        domain,
        page,
        _request_auth,
