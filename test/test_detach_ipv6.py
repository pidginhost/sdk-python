...
class TestDetachIPv6(unittest.TestCase):
    """DetachIPv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetachIPv6:
        """Test DetachIPv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetachIPv6`
        """
        model = DetachIPv6()
        if include_optional:
            return DetachIPv6(
