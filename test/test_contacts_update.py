...
class TestContactsUpdate(unittest.TestCase):
    """ContactsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactsUpdate:
        """Test ContactsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactsUpdate`
        """
        model = ContactsUpdate()
        if include_optional:
