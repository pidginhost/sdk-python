...
class SchemaApi:
    ...
    def schema_retrieve2(
        ...
        _param = self._schema_retrieve2_serialize(
            format=format,
            lang=lang,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def schema_retrieve2_with_http_info(
        self,
        format: Optional[StrictStr] = None,
        lang: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def schema_retrieve2_without_preload_content(
        self,
        format: Optional[StrictStr] = None,
        lang: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _schema_retrieve2_serialize(
        self,
        format,
        lang,
        _request_auth,
