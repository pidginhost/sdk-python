...
class DestroyProtectionResponse(BaseModel):
    """
    DestroyProtectionResponse
    """ # noqa: E501
    destroy_protection: StrictBool
    __properties: ClassVar[List[str]] = ["destroy_protection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DestroyProtectionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DestroyProtectionResponse from a dict"""
        if obj is None:
            return None
