...
class TestServerAddResponse(unittest.TestCase):
    """ServerAddResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerAddResponse:
        """Test ServerAddResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerAddResponse`
        """
        model = ServerAddResponse()
        if include_optional:
    ...
    def testServerAddResponse(self):
        """Test ServerAddResponse"""
