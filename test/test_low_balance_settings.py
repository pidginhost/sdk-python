...
class TestLowBalanceSettings(unittest.TestCase):
    """LowBalanceSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LowBalanceSettings:
        """Test LowBalanceSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LowBalanceSettings`
        """
        model = LowBalanceSettings()
        if include_optional:
            return LowBalanceSettings(
    ...
    def testLowBalanceSettings(self):
        """Test LowBalanceSettings"""
