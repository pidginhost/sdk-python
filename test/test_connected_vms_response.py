...
class TestConnectedVMsResponse(unittest.TestCase):
    """ConnectedVMsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedVMsResponse:
        """Test ConnectedVMsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectedVMsResponse`
        """
        model = ConnectedVMsResponse()
        if include_optional:
            return ConnectedVMsResponse(
                vms = [
                    pidginhost_sdk.models.connected_vm.ConnectedVM(
                        id = 56, 
                        hostname = '', 
                        ip = '', )
                    ]
    ...
    def testConnectedVMsResponse(self):
        """Test ConnectedVMsResponse"""
