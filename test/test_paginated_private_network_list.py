...
class TestPaginatedPrivateNetworkList(unittest.TestCase):
    """PaginatedPrivateNetworkList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedPrivateNetworkList:
        """Test PaginatedPrivateNetworkList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedPrivateNetworkList`
        """
        model = PaginatedPrivateNetworkList()
        if include_optional:
            return PaginatedPrivateNetworkList(
                ...
                results = [
                    pidginhost_sdk.models.private_network.PrivateNetwork(
                        id = 56, 
                        slug = '', 
                        address = '', 
                        gateway = '', 
    ...
    def testPaginatedPrivateNetworkList(self):
        """Test PaginatedPrivateNetworkList"""
