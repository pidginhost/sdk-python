...
class TestLBFirewallRuleDirectionEnum(unittest.TestCase):
    """LBFirewallRuleDirectionEnum unit test stubs"""
    ...
    def testLBFirewallRuleDirectionEnum(self):
        """Test LBFirewallRuleDirectionEnum"""
        # inst = LBFirewallRuleDirectionEnum()
