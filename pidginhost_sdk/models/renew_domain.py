...
class RenewDomain(BaseModel):
    """
    RenewDomain
    """ # noqa: E501
    years: Annotated[int, Field(strict=True, ge=1)]
    __properties: ClassVar[List[str]] = ["years"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RenewDomain from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RenewDomain from a dict"""
        if obj is None:
            return None
