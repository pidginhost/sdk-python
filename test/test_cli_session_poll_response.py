...
class TestCLISessionPollResponse(unittest.TestCase):
    """CLISessionPollResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CLISessionPollResponse:
        """Test CLISessionPollResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CLISessionPollResponse`
        """
        model = CLISessionPollResponse()
        if include_optional:
    ...
    def testCLISessionPollResponse(self):
        """Test CLISessionPollResponse"""
