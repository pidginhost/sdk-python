...
class TestFloatingIPv6UnauthorizeResponse(unittest.TestCase):
    """FloatingIPv6UnauthorizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv6UnauthorizeResponse:
        """Test FloatingIPv6UnauthorizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv6UnauthorizeResponse`
        """
        model = FloatingIPv6UnauthorizeResponse()
        if include_optional:
    ...
    def testFloatingIPv6UnauthorizeResponse(self):
        """Test FloatingIPv6UnauthorizeResponse"""
