...
class TestAttachIPv6Response(unittest.TestCase):
    """AttachIPv6Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachIPv6Response:
        """Test AttachIPv6Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachIPv6Response`
        """
        model = AttachIPv6Response()
        if include_optional:
            return AttachIPv6Response(
                attached = True,
    ...
    def testAttachIPv6Response(self):
        """Test AttachIPv6Response"""
