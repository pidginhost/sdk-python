...
> AttachIPv4 cloud_servers_attach_ipv4_create(id, attach_ipv4)
...
> DetachIPv4 cloud_servers_detach_ipv4_create(id, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_servers_detach_ipv4_create(id, server=server)
