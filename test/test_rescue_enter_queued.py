...
class TestRescueEnterQueued(unittest.TestCase):
    """RescueEnterQueued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RescueEnterQueued:
        """Test RescueEnterQueued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RescueEnterQueued`
        """
        model = RescueEnterQueued()
        if include_optional:
            return RescueEnterQueued(
                queued = True
            )
        else:
            return RescueEnterQueued(
    ...
    def testRescueEnterQueued(self):
        """Test RescueEnterQueued"""
