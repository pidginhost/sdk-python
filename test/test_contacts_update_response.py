...
class TestContactsUpdateResponse(unittest.TestCase):
    """ContactsUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContactsUpdateResponse:
        """Test ContactsUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContactsUpdateResponse`
        """
        model = ContactsUpdateResponse()
        if include_optional:
    ...
    def testContactsUpdateResponse(self):
        """Test ContactsUpdateResponse"""
