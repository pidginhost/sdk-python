...
class TestK8sPortForward(unittest.TestCase):
    """K8sPortForward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> K8sPortForward:
        """Test K8sPortForward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `K8sPortForward`
        """
        model = K8sPortForward()
        if include_optional:
            return K8sPortForward(
                id = 56,
                internal_ip = '',
                port = 0,
                protocol = 'tcp'
