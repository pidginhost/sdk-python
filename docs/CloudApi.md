...
> AttachIPv4Response cloud_servers_attach_ipv4_create(id, attach_ipv4)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pidginhost_sdk.CloudApi(api_client)
    id = 56 # int | A unique integer value identifying this virtual machine.
    attach_ipv4 = pidginhost_sdk.AttachIPv4() # AttachIPv4 | 

    try:
        api_response = api_instance.cloud_servers_attach_ipv4_create(id, attach_ipv4)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this virtual machine. | 
 **attach_ipv4** | [**AttachIPv4**](AttachIPv4.md)|  | 
...
> AttachIPv6 cloud_servers_attach_ipv6_create(id, attach_ipv6)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pidginhost_sdk.CloudApi(api_client)
    id = 56 # int | A unique integer value identifying this virtual machine.
    attach_ipv6 = pidginhost_sdk.AttachIPv6() # AttachIPv6 | 

    try:
        api_response = api_instance.cloud_servers_attach_ipv6_create(id, attach_ipv6)
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this virtual machine. | 
 **attach_ipv6** | [**AttachIPv6**](AttachIPv6.md)|  | 
...
> ConsoleToken cloud_servers_console_create(id, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = pidginhost_sdk.CloudApi(api_client)
    id = 56 # int | A unique integer value identifying this virtual machine.
    server = pidginhost_sdk.Server() # Server |  (optional)

    try:
        api_response = api_instance.cloud_servers_console_create(id, server=server)
...
> DestroyProtection cloud_servers_destroy_protection_create(id, destroy_protection)
...
> DetachIPv4Response cloud_servers_detach_ipv4_create(id, ipv4=ipv4, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_servers_detach_ipv4_create(id, ipv4=ipv4, server=server)
...
> DetachIPv6 cloud_servers_detach_ipv6_create(id, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_servers_detach_ipv6_create(id, server=server)
...
> RetryProvision cloud_servers_retry_provision_create(id, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_servers_retry_provision_create(id, server=server)
...
> SnapshotRollbackQueued cloud_servers_snapshots_rollback_create(id, snapshot_name, server=server)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_servers_snapshots_rollback_create(id, snapshot_name, server=server)
