...
class AttachIPv6Response(BaseModel):
    """
    AttachIPv6Response
    """ # noqa: E501
    attached: StrictBool
    reboot_required: StrictBool
    rebooted: StrictBool
    __properties: ClassVar[List[str]] = ["attached", "reboot_required", "rebooted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reboot_required": obj.get("reboot_required"),
            "rebooted": obj.get("rebooted")
        })
        return _obj
