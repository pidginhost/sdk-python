...
from pidginhost_sdk.api_response import ApiResponse, T as ApiResponseT
import pidginhost_sdk.models
from pidginhost_sdk import rest
from pidginhost_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pidginhost_sdk.models, klass)
