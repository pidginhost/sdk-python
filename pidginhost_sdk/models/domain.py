...
class Domain(BaseModel):
    ...
    domain: StrictStr
    tld: TLD
    idna: StrictBool = Field(description="Domain name is encoded with IDN")
    ...
    idna_name: StrictStr
    max_renew_years: StrictInt
    service_status: Optional[StrictStr] = Field(description="Service status")
