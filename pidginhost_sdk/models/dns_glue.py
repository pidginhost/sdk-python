...
class DNSGlue(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=63)] = Field(description="only subdomain part")
    ip: StrictStr
    ip2: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "ip", "ip2"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ip2 (nullable) is None
        # and model_fields_set contains the field
        if self.ip2 is None and "ip2" in self.model_fields_set:
            _dict['ip2'] = None
