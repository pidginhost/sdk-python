...
class TestPowerManagementRequestActionEnum(unittest.TestCase):
    """PowerManagementRequestActionEnum unit test stubs"""
    ...
    def testPowerManagementRequestActionEnum(self):
        """Test PowerManagementRequestActionEnum"""
        # inst = PowerManagementRequestActionEnum()
