...
class TestDisconnectVMRequest(unittest.TestCase):
    """DisconnectVMRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisconnectVMRequest:
        """Test DisconnectVMRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisconnectVMRequest`
        """
        model = DisconnectVMRequest()
        if include_optional:
            return DisconnectVMRequest(
                server = 56
            )
        else:
            return DisconnectVMRequest(
    ...
    def testDisconnectVMRequest(self):
        """Test DisconnectVMRequest"""
