...
class PatchedVolume(BaseModel):
    ...
    size: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="GB")
    product: Optional[StrictStr] = Field(default=None, description="ID or slug")
    attached: Optional[StrictBool] = None
    server: Optional[StrictStr] = ''
    __properties: ClassVar[List[str]] = ["id", "project", "alias", "size", "product", "attached", "server"]
