...
class TestPowerManagementRequest(unittest.TestCase):
    """PowerManagementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerManagementRequest:
        """Test PowerManagementRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerManagementRequest`
        """
        model = PowerManagementRequest()
        if include_optional:
            return PowerManagementRequest(
                action = 'start'
            )
        else:
            return PowerManagementRequest(
    ...
    def testPowerManagementRequest(self):
        """Test PowerManagementRequest"""
