...
class TestSnapshotCreateQueued(unittest.TestCase):
    """SnapshotCreateQueued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotCreateQueued:
        """Test SnapshotCreateQueued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotCreateQueued`
        """
        model = SnapshotCreateQueued()
        if include_optional:
    ...
    def testSnapshotCreateQueued(self):
        """Test SnapshotCreateQueued"""
