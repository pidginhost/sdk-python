...
class TestPatchedTCPRoute(unittest.TestCase):
    """PatchedTCPRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedTCPRoute:
        """Test PatchedTCPRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedTCPRoute`
        """
        model = PatchedTCPRoute()
        if include_optional:
            return PatchedTCPRoute(
                id = 56,
                name = '',
                namespace = '',
                port = 1,
