...
class TestFloatingIPv4AuthorizeResponse(unittest.TestCase):
    """FloatingIPv4AuthorizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv4AuthorizeResponse:
        """Test FloatingIPv4AuthorizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv4AuthorizeResponse`
        """
        model = FloatingIPv4AuthorizeResponse()
        if include_optional:
    ...
    def testFloatingIPv4AuthorizeResponse(self):
        """Test FloatingIPv4AuthorizeResponse"""
