...
class TestPatchedSubscribe(unittest.TestCase):
    """PatchedSubscribe unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedSubscribe:
        """Test PatchedSubscribe
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedSubscribe`
        """
        model = PatchedSubscribe()
        if include_optional:
            return PatchedSubscribe(
                tier = 'starter'
            )
        else:
            return PatchedSubscribe(
