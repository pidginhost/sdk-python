...
class TestNameserversUpdate(unittest.TestCase):
    """NameserversUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NameserversUpdate:
        """Test NameserversUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NameserversUpdate`
        """
        model = NameserversUpdate()
        if include_optional:
            return NameserversUpdate(
                nameservers = [
                    ''
                    ]
            )
    ...
    def testNameserversUpdate(self):
        """Test NameserversUpdate"""
