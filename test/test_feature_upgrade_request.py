...
class TestFeatureUpgradeRequest(unittest.TestCase):
    """FeatureUpgradeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureUpgradeRequest:
        """Test FeatureUpgradeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureUpgradeRequest`
        """
    ...
    def testFeatureUpgradeRequest(self):
        """Test FeatureUpgradeRequest"""
