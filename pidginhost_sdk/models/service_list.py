...
class ServiceList(BaseModel):
    ...
    auto_payment: StrictBool
    company: Optional[ServiceCompany]
    __properties: ClassVar[List[str]] = ["id", "hostname", "status", "price", "next_invoice", "created", "billing_cycle", "auto_payment", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_payment": obj.get("auto_payment"),
            "company": ServiceCompany.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
