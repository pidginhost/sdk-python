...
class TestPatchedProfile(unittest.TestCase):
    """PatchedProfile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedProfile:
        """Test PatchedProfile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedProfile`
        """
        model = PatchedProfile()
        if include_optional:
            return PatchedProfile(
                first_name = '',
                last_name = '',
                funds = '-80728880015280.7',
                phone = ''
            )
        else:
            return PatchedProfile(
