...
class TestDisconnectVMResponse(unittest.TestCase):
    """DisconnectVMResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisconnectVMResponse:
        """Test DisconnectVMResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisconnectVMResponse`
        """
        model = DisconnectVMResponse()
        if include_optional:
    ...
    def testDisconnectVMResponse(self):
        """Test DisconnectVMResponse"""
