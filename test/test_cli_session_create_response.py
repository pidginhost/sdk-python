...
class TestCLISessionCreateResponse(unittest.TestCase):
    """CLISessionCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CLISessionCreateResponse:
        """Test CLISessionCreateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CLISessionCreateResponse`
        """
        model = CLISessionCreateResponse()
        if include_optional:
    ...
    def testCLISessionCreateResponse(self):
        """Test CLISessionCreateResponse"""
