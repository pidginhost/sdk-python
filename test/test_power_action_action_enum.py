...
class TestPowerActionActionEnum(unittest.TestCase):
    """PowerActionActionEnum unit test stubs"""
    ...
    def testPowerActionActionEnum(self):
        """Test PowerActionActionEnum"""
        # inst = PowerActionActionEnum()
