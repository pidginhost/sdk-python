...
class TestServerUpgradeResponse(unittest.TestCase):
    """ServerUpgradeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerUpgradeResponse:
        """Test ServerUpgradeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerUpgradeResponse`
        """
        model = ServerUpgradeResponse()
        if include_optional:
    ...
    def testServerUpgradeResponse(self):
        """Test ServerUpgradeResponse"""
