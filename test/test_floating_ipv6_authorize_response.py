...
class TestFloatingIPv6AuthorizeResponse(unittest.TestCase):
    """FloatingIPv6AuthorizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv6AuthorizeResponse:
        """Test FloatingIPv6AuthorizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv6AuthorizeResponse`
        """
        model = FloatingIPv6AuthorizeResponse()
        if include_optional:
    ...
    def testFloatingIPv6AuthorizeResponse(self):
        """Test FloatingIPv6AuthorizeResponse"""
