...
class TestHardwareGeneration(unittest.TestCase):
    """HardwareGeneration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HardwareGeneration:
        """Test HardwareGeneration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HardwareGeneration`
        """
        model = HardwareGeneration()
        if include_optional:
    ...
    def testHardwareGeneration(self):
        """Test HardwareGeneration"""
