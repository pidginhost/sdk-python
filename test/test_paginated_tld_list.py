...
class TestPaginatedTLDList(unittest.TestCase):
    """PaginatedTLDList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedTLDList:
        """Test PaginatedTLDList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedTLDList`
        """
        model = PaginatedTLDList()
        if include_optional:
