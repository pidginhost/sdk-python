...
class TestFeatureUpgradeResponse(unittest.TestCase):
    """FeatureUpgradeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureUpgradeResponse:
        """Test FeatureUpgradeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeatureUpgradeResponse`
        """
        model = FeatureUpgradeResponse()
        if include_optional:
    ...
    def testFeatureUpgradeResponse(self):
        """Test FeatureUpgradeResponse"""
