...
class TestRemoveServerResponse(unittest.TestCase):
    """RemoveServerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveServerResponse:
        """Test RemoveServerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveServerResponse`
        """
        model = RemoveServerResponse()
        if include_optional:
    ...
    def testRemoveServerResponse(self):
        """Test RemoveServerResponse"""
