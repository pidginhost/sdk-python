...
class PatchedClusterDetail(BaseModel):
    ...
    dual_stack: Optional[StrictBool] = None
    protected: Optional[StrictBool] = None
    talos_version: Optional[StrictStr] = None
    talos_upgrade_available: Optional[StrictBool] = None
    talos_next_version: Optional[StrictStr] = None
    storage_quota_gb: Optional[StrictInt] = None
    last_pool_used_bytes: Optional[StrictInt] = None
