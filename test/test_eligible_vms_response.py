...
class TestEligibleVMsResponse(unittest.TestCase):
    """EligibleVMsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EligibleVMsResponse:
        """Test EligibleVMsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EligibleVMsResponse`
        """
        model = EligibleVMsResponse()
        if include_optional:
            return EligibleVMsResponse(
                vms = [
                    pidginhost_sdk.models.eligible_vm.EligibleVM(
                        id = 56, 
                        hostname = '', )
                    ]
            )
    ...
    def testEligibleVMsResponse(self):
        """Test EligibleVMsResponse"""
