...
class TestPaginatedPublicIPv4List(unittest.TestCase):
    """PaginatedPublicIPv4List unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedPublicIPv4List:
        """Test PaginatedPublicIPv4List
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedPublicIPv4List`
        """
        model = PaginatedPublicIPv4List()
        if include_optional:
            return PaginatedPublicIPv4List(
                ...
                results = [
                    pidginhost_sdk.models.public_ipv4.PublicIPv4(
                        id = 56, 
                        slug = '', 
                        address = '', 
                        gateway = '', 
    ...
    def testPaginatedPublicIPv4List(self):
        """Test PaginatedPublicIPv4List"""
