...
class TestRetryProvision(unittest.TestCase):
    """RetryProvision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetryProvision:
        """Test RetryProvision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetryProvision`
        """
        model = RetryProvision()
        if include_optional:
