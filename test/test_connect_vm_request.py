...
class TestConnectVMRequest(unittest.TestCase):
    """ConnectVMRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectVMRequest:
        """Test ConnectVMRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectVMRequest`
        """
        model = ConnectVMRequest()
        if include_optional:
            return ConnectVMRequest(
                server = 56
            )
        else:
            return ConnectVMRequest(
