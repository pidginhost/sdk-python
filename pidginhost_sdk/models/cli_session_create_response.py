...
class CLISessionCreateResponse(BaseModel):
    """
    ...
    poll_interval: StrictInt = Field(description="Recommended polling interval in seconds")
    __properties: ClassVar[List[str]] = ["session_id", "verification_url", "expires_at", "poll_interval"]
