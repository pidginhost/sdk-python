...
class TestAttachIPv6Request(unittest.TestCase):
    """AttachIPv6Request unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachIPv6Request:
        """Test AttachIPv6Request
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachIPv6Request`
        """
    ...
    def testAttachIPv6Request(self):
        """Test AttachIPv6Request"""
