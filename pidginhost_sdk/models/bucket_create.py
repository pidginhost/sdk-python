...
class BucketCreate(BaseModel):
    ...
    quota_gb: Annotated[int, Field(strict=True, ge=1)]
    public_read: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["name", "quota_gb", "public_read"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "public_read": obj.get("public_read") if obj.get("public_read") is not None else False
        })
        return _obj
