...
class TestFloatingIPv4UnauthorizeResponse(unittest.TestCase):
    """FloatingIPv4UnauthorizeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv4UnauthorizeResponse:
        """Test FloatingIPv4UnauthorizeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv4UnauthorizeResponse`
        """
        model = FloatingIPv4UnauthorizeResponse()
        if include_optional:
    ...
    def testFloatingIPv4UnauthorizeResponse(self):
        """Test FloatingIPv4UnauthorizeResponse"""
