...
class TestActivityLogResponse(unittest.TestCase):
    """ActivityLogResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityLogResponse:
        """Test ActivityLogResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityLogResponse`
        """
        model = ActivityLogResponse()
        if include_optional:
            return ActivityLogResponse(
                logs = [
                    pidginhost_sdk.models.activity_log_entry.ActivityLogEntry(
                        message = '', 
                        date = '', )
                    ]
            )
    ...
    def testActivityLogResponse(self):
        """Test ActivityLogResponse"""
