...
class TestBucketVisibility(unittest.TestCase):
    """BucketVisibility unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketVisibility:
        """Test BucketVisibility
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketVisibility`
        """
        model = BucketVisibility()
        if include_optional:
