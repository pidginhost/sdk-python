...
class TestDetachIPv6Response(unittest.TestCase):
    """DetachIPv6Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetachIPv6Response:
        """Test DetachIPv6Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetachIPv6Response`
        """
        model = DetachIPv6Response()
        if include_optional:
    ...
    def testDetachIPv6Response(self):
        """Test DetachIPv6Response"""
