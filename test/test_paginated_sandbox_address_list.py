...
class TestPaginatedSandboxAddressList(unittest.TestCase):
    """PaginatedSandboxAddressList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSandboxAddressList:
        """Test PaginatedSandboxAddressList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSandboxAddressList`
        """
        model = PaginatedSandboxAddressList()
        if include_optional:
            return PaginatedSandboxAddressList(
                ...
                results = [
                    pidginhost_sdk.models.sandbox_address.SandboxAddress(
                        id = 56, 
                        address = '', 
                        verified_at = '', 
                        created_at = '', )
    ...
    def testPaginatedSandboxAddressList(self):
        """Test PaginatedSandboxAddressList"""
