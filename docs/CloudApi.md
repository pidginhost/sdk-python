...
> FloatingIPv4 cloud_floating_ipv4_authorizations_retrieve(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_floating_ipv4_authorizations_retrieve(id)
        print("The response of CloudApi->cloud_floating_ipv4_authorizations_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CloudApi->cloud_floating_ipv4_authorizations_retrieve: %s\n" % e)
```
...
> FloatingIPv6 cloud_floating_ipv6_authorizations_retrieve(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_floating_ipv6_authorizations_retrieve(id)
        print("The response of CloudApi->cloud_floating_ipv6_authorizations_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CloudApi->cloud_floating_ipv6_authorizations_retrieve: %s\n" % e)
```
