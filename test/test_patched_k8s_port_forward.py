...
class TestPatchedK8sPortForward(unittest.TestCase):
    """PatchedK8sPortForward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedK8sPortForward:
        """Test PatchedK8sPortForward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedK8sPortForward`
        """
        model = PatchedK8sPortForward()
        if include_optional:
            return PatchedK8sPortForward(
                id = 56,
                internal_ip = '',
                port = 0,
                protocol = 'tcp'
    ...
    def testPatchedK8sPortForward(self):
        """Test PatchedK8sPortForward"""
