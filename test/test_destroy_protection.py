...
class TestDestroyProtection(unittest.TestCase):
    """DestroyProtection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestroyProtection:
        """Test DestroyProtection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestroyProtection`
        """
        model = DestroyProtection()
        if include_optional:
    ...
    def testDestroyProtection(self):
        """Test DestroyProtection"""
