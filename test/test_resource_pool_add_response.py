...
class TestResourcePoolAddResponse(unittest.TestCase):
    """ResourcePoolAddResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourcePoolAddResponse:
        """Test ResourcePoolAddResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourcePoolAddResponse`
        """
        model = ResourcePoolAddResponse()
        if include_optional:
    ...
    def testResourcePoolAddResponse(self):
        """Test ResourcePoolAddResponse"""
