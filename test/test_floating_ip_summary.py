...
class TestFloatingIPSummary(unittest.TestCase):
    """FloatingIPSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPSummary:
        """Test FloatingIPSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPSummary`
        """
        model = FloatingIPSummary()
        if include_optional:
            return FloatingIPSummary(
                id = 56,
                version = 'ipv4',
                address = '',
                label = '',
    ...
    def testFloatingIPSummary(self):
        """Test FloatingIPSummary"""
