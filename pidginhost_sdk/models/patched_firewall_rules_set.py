...
class PatchedFirewallRulesSet(BaseModel):
    """
    PatchedFirewallRulesSet
    """ # noqa: E501
    id: Optional[StrictInt] = None
    name: Optional[Annotated[str, Field(strict=True, max_length=200)]] = None
    status: Optional[FirewallRulesSetStatusEnum] = None
    rules: Optional[List[FirewallRule]] = None
    read_only: Optional[StrictBool] = Field(default=None, description="used with free tier vm")
