...
class TestTicketReopenResponse(unittest.TestCase):
    """TicketReopenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketReopenResponse:
        """Test TicketReopenResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketReopenResponse`
        """
        model = TicketReopenResponse()
        if include_optional:
    ...
    def testTicketReopenResponse(self):
        """Test TicketReopenResponse"""
