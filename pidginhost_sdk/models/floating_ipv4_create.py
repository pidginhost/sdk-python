...
class FloatingIPv4Create(BaseModel):
    """
    FloatingIPv4Create
    """ # noqa: E501
    label: Optional[Annotated[str, Field(strict=True, max_length=64)]] = ''
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FloatingIPv4Create from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FloatingIPv4Create from a dict"""
        if obj is None:
            return None
