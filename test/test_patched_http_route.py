...
class TestPatchedHTTPRoute(unittest.TestCase):
    """PatchedHTTPRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedHTTPRoute:
        """Test PatchedHTTPRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedHTTPRoute`
        """
        model = PatchedHTTPRoute()
        if include_optional:
            return PatchedHTTPRoute(
                id = 56,
                name = '',
                namespace = '',
                hostnames = [
