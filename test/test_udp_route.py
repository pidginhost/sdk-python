...
class TestUDPRoute(unittest.TestCase):
    """UDPRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UDPRoute:
        """Test UDPRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UDPRoute`
        """
        model = UDPRoute()
        if include_optional:
            return UDPRoute(
