...
class TestBucketCancelResponse(unittest.TestCase):
    """BucketCancelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketCancelResponse:
        """Test BucketCancelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketCancelResponse`
        """
        model = BucketCancelResponse()
        if include_optional:
            return BucketCancelResponse(
                id = 56,
                status = ''
            )
        else:
    ...
    def testBucketCancelResponse(self):
        """Test BucketCancelResponse"""
