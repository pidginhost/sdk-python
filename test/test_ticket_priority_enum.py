...
class TestTicketPriorityEnum(unittest.TestCase):
    """TicketPriorityEnum unit test stubs"""
    ...
    def testTicketPriorityEnum(self):
        """Test TicketPriorityEnum"""
        # inst = TicketPriorityEnum()
