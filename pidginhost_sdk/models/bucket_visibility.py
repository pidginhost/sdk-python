...
class BucketVisibility(BaseModel):
    """
    BucketVisibility
    """ # noqa: E501
    public_read: StrictBool
    __properties: ClassVar[List[str]] = ["public_read"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BucketVisibility from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BucketVisibility from a dict"""
        if obj is None:
            return None
