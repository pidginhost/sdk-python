...
class TestDedicatedRDNS(unittest.TestCase):
    """DedicatedRDNS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DedicatedRDNS:
        """Test DedicatedRDNS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DedicatedRDNS`
        """
        model = DedicatedRDNS()
        if include_optional:
            return DedicatedRDNS(
                ip_id = 56,
                reverse_dns = ''
            )
        else:
