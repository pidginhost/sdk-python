...
class TestFirewallRulesSet(unittest.TestCase):
    """FirewallRulesSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FirewallRulesSet:
        """Test FirewallRulesSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirewallRulesSet`
        """
        model = FirewallRulesSet()
        if include_optional:
