...
class PatchedPrivateNetwork(BaseModel):
    """
    PatchedPrivateNetwork
    """ # noqa: E501
    id: Optional[StrictInt] = None
    slug: Optional[StrictStr] = Field(default=None, description="CIDR format")
    address: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="CIDR format")
    gateway: Optional[StrictStr] = None
    provisioned: Optional[StrictBool] = None
    servers: Optional[List[Dict[str, StrictStr]]] = None
