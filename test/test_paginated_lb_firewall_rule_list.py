...
class TestPaginatedLBFirewallRuleList(unittest.TestCase):
    """PaginatedLBFirewallRuleList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedLBFirewallRuleList:
        """Test PaginatedLBFirewallRuleList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedLBFirewallRuleList`
        """
        model = PaginatedLBFirewallRuleList()
        if include_optional:
            return PaginatedLBFirewallRuleList(
                ...
                results = [
                    pidginhost_sdk.models.lb_firewall_rule.LBFirewallRule(
                        id = 56, 
                        direction = 'in', 
                        action = 'ACCEPT', 
                        protocol = '', 
    ...
    def testPaginatedLBFirewallRuleList(self):
        """Test PaginatedLBFirewallRuleList"""
