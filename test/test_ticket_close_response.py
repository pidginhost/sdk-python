...
class TestTicketCloseResponse(unittest.TestCase):
    """TicketCloseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TicketCloseResponse:
        """Test TicketCloseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketCloseResponse`
        """
        model = TicketCloseResponse()
        if include_optional:
    ...
    def testTicketCloseResponse(self):
        """Test TicketCloseResponse"""
