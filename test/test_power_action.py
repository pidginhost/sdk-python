...
class TestPowerAction(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PowerAction:
        """Test PowerAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerAction`
        """
        model = PowerAction()
        if include_optional:
            return PowerAction(
