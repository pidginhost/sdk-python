...
class TestFundsBalanceResponse(unittest.TestCase):
    """FundsBalanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FundsBalanceResponse:
        """Test FundsBalanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FundsBalanceResponse`
        """
        model = FundsBalanceResponse()
        if include_optional:
            return FundsBalanceResponse(
                balance = '-80728880015280.7',
                threshold_type = '',
    ...
    def testFundsBalanceResponse(self):
        """Test FundsBalanceResponse"""
