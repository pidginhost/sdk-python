...
class TestConsoleToken(unittest.TestCase):
    """ConsoleToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsoleToken:
        """Test ConsoleToken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsoleToken`
        """
        model = ConsoleToken()
        if include_optional:
            return ConsoleToken(
