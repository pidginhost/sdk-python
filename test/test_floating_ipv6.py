...
class TestFloatingIPv6(unittest.TestCase):
    """FloatingIPv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPv6:
        """Test FloatingIPv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPv6`
        """
        model = FloatingIPv6()
        if include_optional:
            return FloatingIPv6(
