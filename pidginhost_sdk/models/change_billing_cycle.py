...
class ChangeBillingCycle(BaseModel):
    """
    ChangeBillingCycle
    """ # noqa: E501
    billing_cycle_id: StrictInt
    __properties: ClassVar[List[str]] = ["billing_cycle_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChangeBillingCycle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChangeBillingCycle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "billing_cycle_id": obj.get("billing_cycle_id")
        })
        return _obj
