...
class TestPaginatedResourcePoolNodeList(unittest.TestCase):
    """PaginatedResourcePoolNodeList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResourcePoolNodeList:
        """Test PaginatedResourcePoolNodeList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResourcePoolNodeList`
        """
        model = PaginatedResourcePoolNodeList()
        if include_optional:
    ...
    def testPaginatedResourcePoolNodeList(self):
        """Test PaginatedResourcePoolNodeList"""
