...
class ResourcePoolAdd(BaseModel):
    """
    ResourcePoolAdd
    """ # noqa: E501
    resource_pool_package: StrictStr = Field(description="ID or slug")
    resource_pool_size: Annotated[int, Field(strict=True, ge=1)]
    generation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["resource_pool_package", "resource_pool_size", "generation"]
