...
class TestDetachIPv4(unittest.TestCase):
    """DetachIPv4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetachIPv4:
        """Test DetachIPv4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetachIPv4`
        """
        model = DetachIPv4()
        if include_optional:
            return DetachIPv4(
