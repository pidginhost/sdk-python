...
class TestTransferRoDomain(unittest.TestCase):
    """TransferRoDomain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferRoDomain:
        """Test TransferRoDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferRoDomain`
        """
        model = TransferRoDomain()
        if include_optional:
