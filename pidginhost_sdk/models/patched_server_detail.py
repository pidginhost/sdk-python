...
class PatchedServerDetail(BaseModel):
    ...
    custom_os: Optional[StrictBool] = Field(default=None, description="Customer installed their own OS from an ISO; cloud-init features no longer apply")
    rescue_mode: Optional[StrictBool] = None
    boot_iso: Optional[StrictStr] = None
    rescue_supported: Optional[StrictBool] = None
