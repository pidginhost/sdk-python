...
class CLISessionPollResponse(BaseModel):
    ...
    account: Optional[StrictStr] = Field(default=None, description="Bound account, when the token is membership-bound")
    membership_status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "token_key", "token_name", "token_scope", "account", "membership_status"]
