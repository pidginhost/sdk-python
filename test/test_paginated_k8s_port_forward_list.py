...
class TestPaginatedK8sPortForwardList(unittest.TestCase):
    """PaginatedK8sPortForwardList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedK8sPortForwardList:
        """Test PaginatedK8sPortForwardList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedK8sPortForwardList`
        """
        model = PaginatedK8sPortForwardList()
        if include_optional:
            return PaginatedK8sPortForwardList(
                count = 123,
                next = 'http://api.example.org/accounts/?page=4',
                previous = 'http://api.example.org/accounts/?page=2',
                results = [
                    pidginhost_sdk.models.k8s_port_forward.K8sPortForward(
                        id = 56, 
                        internal_ip = '', 
                        port = 0, 
                        protocol = 'tcp', )
    ...
    def testPaginatedK8sPortForwardList(self):
        """Test PaginatedK8sPortForwardList"""
