...
class TestNodeRRDResponse(unittest.TestCase):
    """NodeRRDResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NodeRRDResponse:
        """Test NodeRRDResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NodeRRDResponse`
        """
        model = NodeRRDResponse()
        if include_optional:
