...
class TestBucketCredentials(unittest.TestCase):
    """BucketCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BucketCredentials:
        """Test BucketCredentials
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BucketCredentials`
        """
    ...
    def testBucketCredentials(self):
        """Test BucketCredentials"""
