...
class SnapshotCreate(BaseModel):
    ...
    SnapshotCreate
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=40)] = Field(description="Must start with a letter; letters, numbers, \"_\" and \"-\" only (2-40 characters).")
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if isinstance(value, str) and not re.match(r"^[A-Za-z][A-Za-z0-9_-]{1,39}$", value):
            raise ValueError(r"must validate the regular expression /^[A-Za-z][A-Za-z0-9_-]{1,39}$/")
        return value
