...
class TestPowerActionResponse(unittest.TestCase):
    """PowerActionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PowerActionResponse:
        """Test PowerActionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PowerActionResponse`
        """
        model = PowerActionResponse()
        if include_optional:
    ...
    def testPowerActionResponse(self):
        """Test PowerActionResponse"""
