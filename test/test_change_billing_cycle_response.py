...
class TestChangeBillingCycleResponse(unittest.TestCase):
    """ChangeBillingCycleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChangeBillingCycleResponse:
        """Test ChangeBillingCycleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChangeBillingCycleResponse`
        """
        model = ChangeBillingCycleResponse()
        if include_optional:
    ...
    def testChangeBillingCycleResponse(self):
        """Test ChangeBillingCycleResponse"""
