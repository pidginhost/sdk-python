...
> BucketCredentials cloud_buckets_credentials_reveal_create(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_buckets_credentials_reveal_create(id)
...
> BucketCredentials cloud_buckets_credentials_rotate_create(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_buckets_credentials_rotate_create(id)
...
> BucketCancelResponse cloud_buckets_destroy(id)
...
with pidginhost_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.cloud_buckets_destroy(id)
        print("The response of CloudApi->cloud_buckets_destroy:\n")
        pprint(api_response)
    except Exception as e:
...
[**BucketCancelResponse**](BucketCancelResponse.md)
