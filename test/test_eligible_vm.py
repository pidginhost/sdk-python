...
class TestEligibleVM(unittest.TestCase):
    """EligibleVM unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EligibleVM:
        """Test EligibleVM
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EligibleVM`
        """
        model = EligibleVM()
        if include_optional:
            return EligibleVM(
