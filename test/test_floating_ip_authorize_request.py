...
class TestFloatingIPAuthorizeRequest(unittest.TestCase):
    """FloatingIPAuthorizeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FloatingIPAuthorizeRequest:
        """Test FloatingIPAuthorizeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIPAuthorizeRequest`
        """
        model = FloatingIPAuthorizeRequest()
        if include_optional:
            return FloatingIPAuthorizeRequest(
                server_id = 1
            )
        else:
            return FloatingIPAuthorizeRequest(
    ...
    def testFloatingIPAuthorizeRequest(self):
        """Test FloatingIPAuthorizeRequest"""
