...
class TestPayWithFundsResponse(unittest.TestCase):
    """PayWithFundsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayWithFundsResponse:
        """Test PayWithFundsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayWithFundsResponse`
        """
        model = PayWithFundsResponse()
        if include_optional:
    ...
    def testPayWithFundsResponse(self):
        """Test PayWithFundsResponse"""
