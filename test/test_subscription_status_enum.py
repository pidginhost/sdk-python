...
class TestSubscriptionStatusEnum(unittest.TestCase):
    """SubscriptionStatusEnum unit test stubs"""
    ...
    def testSubscriptionStatusEnum(self):
        """Test SubscriptionStatusEnum"""
        # inst = SubscriptionStatusEnum()
