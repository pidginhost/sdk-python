...
class TestPaginatedStorageProductList(unittest.TestCase):
    """PaginatedStorageProductList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedStorageProductList:
        """Test PaginatedStorageProductList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedStorageProductList`
        """
        model = PaginatedStorageProductList()
        if include_optional:
            return PaginatedStorageProductList(
                ...
                results = [
                    pidginhost_sdk.models.storage_product.StorageProduct(
                        id = 56, 
                        slug = 'z', 
                        name = '', 
                        type = '', 
    ...
    def testPaginatedStorageProductList(self):
        """Test PaginatedStorageProductList"""
