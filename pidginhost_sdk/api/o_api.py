...
class OApi:
    ...
    def o_register_create(
        ...
        _param = self._o_register_create_serialize(
    ...
    @validate_call
    def o_register_create_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def o_register_create_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _o_register_create_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
