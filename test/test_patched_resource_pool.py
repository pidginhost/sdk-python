...
class TestPatchedResourcePool(unittest.TestCase):
    """PatchedResourcePool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchedResourcePool:
        """Test PatchedResourcePool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedResourcePool`
        """
        model = PatchedResourcePool()
        if include_optional:
            return PatchedResourcePool(
                id = 56,
                package = '',
                generation = '',
                size = '',
    ...
    def testPatchedResourcePool(self):
        """Test PatchedResourcePool"""
