...
class TestPaginatedServerProductList(unittest.TestCase):
    """PaginatedServerProductList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedServerProductList:
        """Test PaginatedServerProductList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedServerProductList`
        """
        model = PaginatedServerProductList()
        if include_optional:
            return PaginatedServerProductList(
                ...
                results = [
                    pidginhost_sdk.models.server_product.ServerProduct(
                        id = 56, 
                        slug = 'z', 
                        name = '', )
                    ]
    ...
    def testPaginatedServerProductList(self):
        """Test PaginatedServerProductList"""
