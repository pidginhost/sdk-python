...
class TestPaginatedSSHKeyList(unittest.TestCase):
    """PaginatedSSHKeyList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSSHKeyList:
        """Test PaginatedSSHKeyList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSSHKeyList`
        """
        model = PaginatedSSHKeyList()
        if include_optional:
            return PaginatedSSHKeyList(
                ...
                results = [
                    pidginhost_sdk.models.ssh_key.SSHKey(
                        id = 56, 
                        alias = '', 
                        fingerprint = '', 
                        key = '', )
    ...
    def testPaginatedSSHKeyList(self):
        """Test PaginatedSSHKeyList"""
