...
class FloatingIPv4(BaseModel):
    ...
    address: StrictStr
    gateway: StrictStr
    prefix: Annotated[int, Field(le=32767, strict=True, ge=0)]
    reverse_dns: StrictStr
    label: Optional[Annotated[str, Field(strict=True, max_length=64)]] = None
    authorized_vm_count: StrictInt
    created_at: StrictStr
    __properties: ClassVar[List[str]] = ["id", "address", "gateway", "prefix", "reverse_dns", "label", "authorized_vm_count", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reverse_dns": obj.get("reverse_dns"),
            "label": obj.get("label"),
            "authorized_vm_count": obj.get("authorized_vm_count"),
