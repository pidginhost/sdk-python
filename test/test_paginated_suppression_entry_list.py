...
class TestPaginatedSuppressionEntryList(unittest.TestCase):
    """PaginatedSuppressionEntryList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedSuppressionEntryList:
        """Test PaginatedSuppressionEntryList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedSuppressionEntryList`
        """
        model = PaginatedSuppressionEntryList()
        if include_optional:
            return PaginatedSuppressionEntryList(
                ...
                results = [
                    pidginhost_sdk.models.suppression_entry.SuppressionEntry(
                        id = 56, 
                        address = '', 
                        reason = null, 
                        detail = '', 
    ...
    def testPaginatedSuppressionEntryList(self):
        """Test PaginatedSuppressionEntryList"""
