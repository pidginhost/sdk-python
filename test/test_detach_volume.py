...
class TestDetachVolume(unittest.TestCase):
    """DetachVolume unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetachVolume:
        """Test DetachVolume
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetachVolume`
        """
        model = DetachVolume()
        if include_optional:
            return DetachVolume(
