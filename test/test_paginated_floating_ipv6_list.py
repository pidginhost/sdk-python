...
class TestPaginatedFloatingIPv6List(unittest.TestCase):
    """PaginatedFloatingIPv6List unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedFloatingIPv6List:
        """Test PaginatedFloatingIPv6List
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedFloatingIPv6List`
        """
        model = PaginatedFloatingIPv6List()
        if include_optional:
            return PaginatedFloatingIPv6List(
                ...
                results = [
                    pidginhost_sdk.models.floating_ipv6.FloatingIPv6(
                        id = 56, 
                        address = '', 
                        gateway = '', 
                        prefix = 0, 
    ...
    def testPaginatedFloatingIPv6List(self):
        """Test PaginatedFloatingIPv6List"""
