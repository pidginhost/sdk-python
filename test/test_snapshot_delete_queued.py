...
class TestSnapshotDeleteQueued(unittest.TestCase):
    """SnapshotDeleteQueued unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotDeleteQueued:
        """Test SnapshotDeleteQueued
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotDeleteQueued`
        """
        model = SnapshotDeleteQueued()
        if include_optional:
    ...
    def testSnapshotDeleteQueued(self):
        """Test SnapshotDeleteQueued"""
