...
class TestDeactivateFreeDNSResponse(unittest.TestCase):
    """DeactivateFreeDNSResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeactivateFreeDNSResponse:
        """Test DeactivateFreeDNSResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeactivateFreeDNSResponse`
        """
        model = DeactivateFreeDNSResponse()
        if include_optional:
    ...
    def testDeactivateFreeDNSResponse(self):
        """Test DeactivateFreeDNSResponse"""
