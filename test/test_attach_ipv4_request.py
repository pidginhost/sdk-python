...
class TestAttachIPv4Request(unittest.TestCase):
    """AttachIPv4Request unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttachIPv4Request:
        """Test AttachIPv4Request
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttachIPv4Request`
        """
    ...
    def testAttachIPv4Request(self):
        """Test AttachIPv4Request"""
